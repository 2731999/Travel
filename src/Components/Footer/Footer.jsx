      ...
      <div className='secContent container'>
        ...
        <div className='footerCard flex'>
          <div className='footerIntro flex'>
            ...
            <div data-aos="fade-up" className="footerParagraphes">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Suscipit eos sunt eaque, 
              tempore voluptas consequuntur officiis commodi harum quod totam earum doloribus 
              maxime sed magni vel, rem deleniti modi. Eaque?
            </div>
          ...
          <div className="footerDiv flex">
            ...
            <small>ABHISHEK KUMAR - NOVEMBER 2022</small>
          </div>
        </div>
      </div>
    </section>
